...
function startGazeTracking() {
    ...
    .then((stream) => {
        ...
        // Start the GazeCloudAPI eye-tracking
        GazeCloudAPI.StartEyeTracking();
    })
    .catch((err) => {
        console.error("Camera access denied:", err.message);
        alert("Please allow camera access to use eye tracking.");
    });
...
document.addEventListener("DOMContentLoaded", () => {
    document.getElementById("startButton").addEventListener("click", startGazeTracking);
});
